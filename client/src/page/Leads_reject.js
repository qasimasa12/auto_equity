    ...
    React.useEffect(()=>{
      ...
      React.useEffect(() => {
        ...
        setSearch(filteredTable)
            ...
            setLeads_reject(fetchTableData);
                    ...
                    <div className='col-12 '>
                        ...
                        <div className='mt-4 row row_width ms-2 me-2'>
                            ...
                            <div className='col-12 col-md-3 rowell'>
                                ...
                                <Form.Select onChange={(e)=>handleChangeDate(e)} aria-label="Default select example" className='size_select fondsixw ms-2'>
